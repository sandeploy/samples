...
type
  TfCreateVolume = class(TForm)
    ...
    Label40: TLabel;
    Image12: TImage;
    chkSSDCache: TCheckBox;
    edSSDCachePath: TEdit;
    edSSDCacheSize: TSpinEdit;
    Label41: TLabel;
    Label42: TLabel;
...
begin
  Case Notebook.PageIndex of
     ...
     0: begin
          ...
          begin
            FIScsiTarget.iScsiTargetMediaType:= ISCSI_TARGET_MEDIA_TYPE_VMDK;
            FIScsiTarget.iScsiTargetDeviceType:= ISCSI_TARGET_TYPE_DISK;
     ...
     begin
       ...
       if FIScsiTarget.Params.ImageFile.CreateNew = false then
         FIScsiTarget.DeviceSize.QuadPart:= 0;
     ...
     begin
       ...
       FillChar(FIScsiTarget.SSDcache,sizeof(FIScsiTarget.SSDcache),0);
       FIScsiTarget.SSDcache.EnableCache:= chkSSDCache.Checked;
       ...
       if FIScsiTarget.SSDcache.EnableCache then
       begin
         nSize:= Int64(edSSDCacheSize.Value) * 1024 * 1024;
         FIScsiTarget.SSDcache.CacheSize.QuadPart:= nSize;
         StrPCopy(@FIScsiTarget.SSDcache.CachePath[0], edSSDCachePath.Text);
       end;
    ...
    10:
    begin
      FillChar(FIScsiTarget.VirtualWrite.VirtualWritePath, SizeOf(FIScsiTarget.VirtualWrite.VirtualWritePath), 0);

      FIScsiTarget.VirtualWrite.VirtualWriteMode:= Integer(CheckBox5.Checked);
      ...
      begin
        ...
        begin
          ...
          StrPCopy(@FIScsiTarget.VirtualWrite.VirtualWritePath, edVirtualWritePath.Text);
        nSize:= Int64(SpinEdit5.Value) * 1024 * 1024;
        FIScsiTarget.VirtualWrite.VirtualWriteQuota.QuadPart:= nSize;
        case cmbBlockSize.ItemIndex of
          ...
          5: FIScsiTarget.StartOffset.QuadPart:= 65536;
        end;
      end;
